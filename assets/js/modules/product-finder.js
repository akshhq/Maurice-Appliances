...
export function initProductFinder() {
  ...
  const optionsMap = {
    "water-heaters": {
      ...
      usages: [
        {
          id: "sink-instant",
          label: "1–2 Persons / Kitchen Sink",
          desc: "Instant 1L to 3L rapid heating geyser with thermal cut-off",
        },
        {
          id: "compact-bath",
          label: "2–3 Persons / Compact Bath",
          desc: "6L to 10L high-efficiency storage geyser for quick baths",
        },
        {
          id: "family-medium",
          label: "3–4 Persons / Standard Family",
          desc: "15L storage geyser with high-density PUF insulation",
        },
        {
          id: "family-large",
          label: "4–6+ Persons / Master Bath",
          desc: "25L to 35L heavy-duty / high-rise pressure geyser",
        },
        {
          id: "commercial-heavy",
          label: "Heavy Demand / Multi-Point",
          desc: "50L commercial storage water heater",
        },
      ],
      features: [
    ...
    "room-heaters": {
      ...
      usages: [
        {
          id: "desk-personal",
          label: "Personal Desk / Study (<100 sq ft)",
          desc: "750W–800W compact quartz or single rod warmer",
        },
        {
          id: "bedroom-silent",
          label: "Master Bedroom (100–180 sq ft)",
          desc: "1000W–1500W silent convection fan blower",
        },
        {
          id: "heat-pillar",
          label: "Master Room / 360° Heating",
          desc: "1500W–2000W Rado carbon & quartz heat pillar",
        },
        {
          id: "hall-large",
          label: "Living Room / Large Hall (>200 sq ft)",
          desc: "2000W double element metal heavy room heater",
        },
        {
          id: "gas-hybrid",
          label: "Winter Power Backup / Off-Grid",
          desc: "Gas & Electric 2-in-1 combo room heater",
        },
      ],
      features: [
    ...
    "gas-stoves": {
      ...
      usages: [
        {
          id: "1-burner",
          label: "Single Chef / Compact Kitchen",
          desc: "1 Burner toughened glass / SS portable stove",
        },
        {
          id: "2-burner",
          label: "Standard Indian Household",
          desc: "2 Burner heavy brass burners with deep drawn drip tray",
        },
        {
          id: "3-burner",
          label: "Multi-Dish Family Cooking",
          desc: "3 Burner tri-pin brass burners with toughened glass",
        },
        {
          id: "4-burner",
          label: "Large Feast / Festive Kitchen",
          desc: "4 Burner jumbo brass cooktop for parallel cooking",
        },
        {
          id: "commercial",
          label: "Commercial Canteen / Large Vessel",
          desc: "Heavy duty commercial single / double burner",
        },
      ],
      features: [
    ...
    induction: {
      ...
      usages: [
        {
          id: "daily-home",
          label: "Everyday Home Cooking",
          desc: "1600W–2000W push-button induction with Indian presets",
        },
        {
          id: "touch-digital",
          label: "Modern Touch Sensor",
          desc: "2000W crystal glass plate with feather touch controls",
        },
        {
          id: "infrared",
          label: "Multi-Cookware Friendly",
          desc: "2200W ceramic infrared cooktop (works with any utensil)",
        },
        {
          id: "commercial",
          label: "Commercial Catering / Restaurant",
          desc: "3500W–5000W heavy gauge stainless steel induction",
        },
      ],
      features: [
    ...
    fans: {
      ...
      usages: [
        {
          id: "ceiling",
          label: "Ceiling Air Circulation",
          desc: '1200mm (48") high-speed aerodynamic ceiling fans',
        },
        {
          id: "table-desk",
          label: "Personal Desk / Study Corner",
          desc: "300mm–400mm table and all-purpose portable fans",
        },
        {
          id: "wall-mount",
          label: "Space Saver Wall Fan",
          desc: "400mm 3-speed oscillating wall mount fan",
        },
        {
          id: "farratta",
          label: "Heavy Outdoor / Hall Air Delivery",
          desc: "600mm Farratta high-velocity pedestal fan",
        },
        {
          id: "ventilation",
          label: "Kitchen & Bathroom Fresh Air",
          desc: "150mm–300mm fresh air & exhaust fans",
        },
      ],
      features: [
    ...
    "mixer-grinders": {
      ...
      usages: [
        {
          id: "2-jar",
          label: "Daily Chutney & Dry Spices",
          desc: "500W 2 stainless steel jars with safety lock",
        },
        {
          id: "3-jar",
          label: "Complete Family Kitchen",
          desc: "600W 3 stainless steel jars with heavy-gauge blades",
        },
        {
          id: "jmg",
          label: "Juicing, Churning & Blending",
          desc: "500W Juicer Mixer Grinder with micro-mesh filter",
        },
        {
          id: "heavy-duty",
          label: "Heavy Duty 30-Min Continuous",
          desc: "600W copper motor with overload protection",
        },
      ],
      features: [
    ...
    chimneys: {
      ...
      usages: [
        {
          id: "60cm-curved",
          label: "Standard 2–3 Burner Stove",
          desc: "60cm curved glass chimney with 1100 m³/h suction",
        },
        {
          id: "60cm-autoclean",
          label: "Auto-Clean & Motion Gesture",
          desc: "60cm wave sensor chimney with 1250 m³/h suction",
        },
        {
          id: "90cm-island",
          label: "Wide 3–4 Burner Hob / Kitchen",
          desc: "90cm high-capacity chimney with 1350 m³/h suction",
        },
      ],
      features: [
    ...
    irons: {
      ...
      usages: [
        {
          id: "light-daily",
          label: "Quick Everyday Pressing",
          desc: "750W lightweight iron with non-stick Teflon soleplate",
        },
        {
          id: "quick-press",
          label: "High Heat Rapid Pressing",
          desc: "1000W Steelo iron with adjustable fabric thermostat",
        },
        {
          id: "heavy-weight",
          label: "Crisp Traditional Pressing",
          desc: "1200W Icon heavy weight metal body iron",
        },
      ],
      features: [
    ...
    madhani: {
      ...
      usages: [
        {
          id: "mini",
          label: "Compact Madhani Mini (75W Mini)",
          desc: "75W Aluminium & Copper winding with 2-way percolation blade for small families",
        },
        {
          id: "domestic",
          label: "Standard Home Madhani (125W–170W)",
          desc: "125W–170W double ball bearing motor with heavy wooden chakla",
        },
        {
          id: "industrial",
          label: "Commercial Madhana (175W–200W)",
          desc: "175W–200W heavy aluminium body & commercial double bearing for halwais & dairies",
        },
      ],
      features: [
    ...
    "kitchen-appliances": {
      ...
      usages: [
        {
          id: "kettle",
          label: "Instant Hot Water & Tea (1.5L–1.8L)",
          desc: "1200W–1500W cordless 360° stainless steel kettles",
        },
        {
          id: "atta-chakki",
          label: "Fresh Whole Grain Flour Milling",
          desc: "Automated domestic Atta Chakki with traditional stone grinding",
        },
      ],
      features: [
  ...
  function getRecommendations() {
    ...
    if (cat === "water-heaters") {
      if (state.usage === "sink-instant")
        list = list.filter((p) => p.capacity === "1L" || p.capacity === "3L");
      else if (state.usage === "compact-bath")
        list = list.filter((p) => p.capacity === "6L" || p.capacity === "10L");
      else if (state.usage === "family-medium")
        list = list.filter((p) => p.capacity === "15L");
      else if (state.usage === "family-large")
        list = list.filter((p) => p.capacity === "25L" || p.capacity === "35L");
      else if (state.usage === "commercial-heavy")
        list = list.filter((p) => p.capacity === "50L");
    } else if (cat === "room-heaters") {
      if (state.usage === "desk-personal")
        list = list.filter((p) => (p.wattage || 0) <= 800);
      else if (state.usage === "bedroom-silent")
        list = list.filter(
          (p) =>
            p.model.includes("BLOWER") ||
            p.title.includes("Blower") ||
            (p.wattage || 0) === 1000,
        );
      else if (state.usage === "heat-pillar")
        list = list.filter(
          (p) =>
            p.model.includes("PILLAR") ||
            p.model.includes("RADO") ||
            p.title.includes("Pillar"),
        );
      else if (state.usage === "hall-large")
        list = list.filter((p) => (p.wattage || 0) >= 2000);
      else if (state.usage === "gas-hybrid")
        list = list.filter(
          (p) => p.model.includes("GAS") || p.title.includes("Gas"),
        );
    } else if (cat === "gas-stoves") {
      if (state.usage === "1-burner")
        list = list.filter(
          (p) => p.model.includes("1") || p.title.includes("1 Burner"),
        );
      else if (state.usage === "2-burner")
        list = list.filter(
          (p) => p.model.includes("2") || p.title.includes("2 Burner"),
        );
      else if (state.usage === "3-burner")
        list = list.filter(
          (p) => p.model.includes("3") || p.title.includes("3 Burner"),
        );
      else if (state.usage === "4-burner")
        list = list.filter(
          (p) => p.model.includes("4") || p.title.includes("4 Burner"),
        );
      else if (state.usage === "commercial")
        list = list.filter(
          (p) =>
            p.model.includes("COMMERCIAL") || p.title.includes("Commercial"),
        );
    } else if (cat === "induction") {
      if (state.usage === "daily-home")
        list = list.filter(
          (p) =>
            (p.wattage || 0) <= 2000 &&
            !p.model.includes("TOUCH") &&
            !p.model.includes("INFRARED"),
        );
      else if (state.usage === "touch-digital")
        list = list.filter(
          (p) =>
            p.model.includes("TOUCH") ||
            p.specs?.some((s) => s.toLowerCase().includes("touch")),
        );
      else if (state.usage === "infrared")
        list = list.filter(
          (p) => p.model.includes("INFRARED") || p.title.includes("Infrared"),
        );
      else if (state.usage === "commercial")
        list = list.filter(
          (p) => (p.wattage || 0) >= 3500 || p.model.includes("COMMERCIAL"),
        );
    } else if (cat === "fans") {
      if (state.usage === "ceiling")
        list = list.filter(
          (p) => p.model.includes("CEILING") || p.title.includes("Ceiling"),
        );
      else if (state.usage === "table-desk")
        list = list.filter(
          (p) =>
            p.model.includes("TABLE") ||
            p.model.includes("ALL PURPOSE") ||
            p.title.includes("Table"),
        );
      else if (state.usage === "wall-mount")
        list = list.filter(
          (p) => p.model.includes("WALL") || p.title.includes("Wall"),
        );
      else if (state.usage === "farratta")
        list = list.filter(
          (p) => p.model.includes("FARRATTA") || p.title.includes("Farratta"),
        );
      else if (state.usage === "ventilation")
        list = list.filter(
          (p) =>
            p.model.includes("EXHAUST") ||
            p.model.includes("FRESH AIR") ||
            p.title.includes("Exhaust") ||
            p.title.includes("Ventilating"),
        );
    } else if (cat === "mixer-grinders") {
      if (state.usage === "2-jar")
        list = list.filter(
          (p) => p.model.includes("2") || p.title.includes("2 Jar"),
        );
      else if (state.usage === "3-jar")
        list = list.filter(
          (p) =>
            p.model.includes("3") ||
            p.title.includes("3 Jar") ||
            p.model.includes("DX"),
        );
      else if (state.usage === "jmg")
        list = list.filter(
          (p) =>
            p.model.includes("JMG") ||
            p.title.includes("JMG") ||
            p.title.includes("Juicer"),
        );
      else if (state.usage === "heavy-duty")
        list = list.filter((p) => (p.wattage || 0) >= 600);
    } else if (cat === "chimneys") {
      if (state.usage === "60cm-curved")
        list = list.filter(
          (p) => p.model.includes("60") && !p.model.includes("AC"),
        );
      else if (state.usage === "60cm-autoclean")
        list = list.filter(
          (p) => p.model.includes("60") && p.model.includes("AC"),
        );
      else if (state.usage === "90cm-island")
        list = list.filter((p) => p.model.includes("90"));
    } else if (cat === "irons") {
      if (state.usage === "light-daily")
        list = list.filter((p) => (p.wattage || 0) <= 750);
      else if (state.usage === "quick-press")
        list = list.filter((p) => (p.wattage || 0) === 1000);
      else if (state.usage === "heavy-weight")
        list = list.filter(
          (p) => (p.wattage || 0) >= 1200 || p.model.includes("ICON"),
        );
    } else if (cat === "madhani") {
      if (state.usage === "mini")
        list = list.filter(
          (p) => p.model.includes("MINI") || (p.wattage || 0) <= 75,
        );
      else if (state.usage === "domestic")
        list = list.filter(
          (p) => !p.model.includes("MINI") && (p.wattage || 0) <= 170,
        );
      else if (state.usage === "industrial")
        list = list.filter((p) => (p.wattage || 0) >= 175);
    } else if (cat === "kitchen-appliances") {
      if (state.usage === "kettle")
        list = list.filter(
          (p) =>
            p.cat === "kitchen-appliances" &&
            (p.model.includes("KETTLE") || p.title.includes("Kettle")),
        );
      else if (state.usage === "atta-chakki")
        list = list.filter(
          (p) => p.model.includes("ATTA") || p.title.includes("Atta"),
        );
    }
    ...
    if (state.feature && state.feature !== "all") {
      const featList = list.filter((p) => {
        ...
        if (state.feature === "mini")
          return text.includes("mini") || (p.wattage || 0) <= 75;
        if (state.feature === "glassline")
          return (
            text.includes("glass") ||
            text.includes("enamel") ||
            text.includes("vitreous")
          );
        if (state.feature === "digital")
          return (
            text.includes("digital") ||
            text.includes("meter") ||
            text.includes("display")
          );
        if (state.feature === "abs")
          return text.includes("abs") || text.includes("shock");
        if (state.feature === "metal")
          return text.includes("metal") || text.includes("ss");
        if (state.feature === "carbon") return text.includes("carbon");
        if (state.feature === "quartz") return text.includes("quartz");
        if (state.feature === "blower")
          return text.includes("blower") || text.includes("fan");
        if (state.feature === "gas") return text.includes("gas");
        if (state.feature === "touch")
          return text.includes("touch") || text.includes("sensor");
        if (state.feature === "push")
          return text.includes("push") || text.includes("button");
        if (state.feature === "heavy")
          return (
            text.includes("heavy") ||
        ...
        if (state.feature === "autoclean")
          return (
            text.includes("auto clean") ||
            text.includes("auto-clean") ||
            text.includes("ac")
          );
        if (state.feature === "motion")
          return (
        ...
        if (state.feature === "teflon")
          return (
            text.includes("teflon") ||
            text.includes("non-stick") ||
            text.includes("coated")
          );
        return true;
      });
  ...
  function render() {
    const activeData =
      optionsMap[state.category] || optionsMap["water-heaters"];
