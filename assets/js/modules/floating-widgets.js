...
export function initFloatingWidgets() {
  ...
  if (!waBtn) {
    ...
    waBtn.href =
      "https://wa.me/919816591699?text=Hello%20Maurice%20Appliances%2C%20I%20have%20an%20inquiry%20regarding%20products%2Fdealership.";
    waBtn.target = "_blank";
    waBtn.rel = "noopener noreferrer";
    waBtn.setAttribute(
      "aria-label",
      "Chat with Maurice Support on WhatsApp (+91 98165-91699)",
    );
    waBtn.innerHTML = `
